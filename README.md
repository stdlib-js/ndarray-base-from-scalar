...
```javascript
scalar2ndarray = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-from-scalar@v0.2.2-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/ndarray-base-from-scalar/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/ndarray-base-from-scalar/actions/workflows/test.yml?query=branch:v0.2.2
