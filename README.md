...
```javascript
scalar2ndarray = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-from-scalar@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-from-scalar@umd/bundle.js"></script>
```
